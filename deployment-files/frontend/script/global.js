const API = "https://or4vn4577g.execute-api.us-east-1.amazonaws.com/kash16/";
...
function generateNavBar(isAdmin) {
  ...
  if (!currentUserID) {
    ...
    navbar.insertAdjacentHTML(
      "beforeend",
      `
              <button class="nav-btn" onclick="window.location.href=\'https://kash14-us-east-1l8fw4esc3.auth.us-east-1.amazoncognito.com/login?client_id=2tvqi6cpet0hubl5cremal20e9&response_type=code&scope=email+openid&redirect_uri=https://kash14-kashishop2.s3.us-east-1.amazonaws.com/main/callback.html\'">Login</button>
          `
    );
  } else if (isAdmin) {
